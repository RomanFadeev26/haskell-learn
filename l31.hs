...
main :: IO ()
main = getLine >>= return . helloPerson >>= putStrLn
...
firstCandidate = Candidate { candidateId = 1
                           , codeReview = A
                           , cultureFit = A
                           , education = PhD }
...
candidate1 = Candidate { candidateId = 11
                       , codeReview = A
                       , cultureFit = A
                       , education = BA }
...
printAssess :: Maybe String -> String
printAssess Nothing = "error id not found" 
printAssess (Just result) = result
